...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/login.php">Logout</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="jumbotron jumbotron-fluid" id="jumbotron">
            <div class="container">
                <div>
                    <h1 class="display-4" style="color:white;">The Best Place to Play.</h1>
                    <p class="lead" style="color:white;">INCREDIBLE GAMES. ENDLESS ENTERTAINMENT.</p>
                </div>
            </div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="ps4.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                    <img src="spiderman.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                    <img src="controller.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
